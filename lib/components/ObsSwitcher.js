...
class ObsSwitcher extends _events.default {
    ...
    return _asyncToGenerator(function* () {
      ...
      if (bitrate !== null) {
        ...
        if (["nimble", "srt-live-server"].includes(_config.default.rtmp.server)) {
          _this.isLive && canSwitch && (bitrate === 0 && currentScene.name !== _this.previousScene && (_this.obs.setCurrentScene({
            "scene-name": _this.previousScene
          }), _this.switchSceneEmit("live", _this.previousScene), log.info("Stream went online switching to scene: \"".concat(_this.previousScene, "\""))), (rtt < _this.highRttTrigger || rtt >= _this.highRttTrigger) && bitrate <= _this.lowBitrateTrigger && currentScene.name !== _this.lowBitrateScene && bitrate !== 0 && (_this.obs.setCurrentScene({
            "scene-name": _this.lowBitrateScene
          }), _this.previousScene = _this.lowBitrateScene, _this.switchSceneEmit("lowBitrateScene"), log.info("Low bitrate detected switching to scene: \"".concat(_this.lowBitrateScene, "\""))), rtt >= _this.highRttTrigger && bitrate > _this.lowBitrateTrigger && currentScene.name !== _this.lowBitrateScene && bitrate !== 0 && (_this.obs.setCurrentScene({
            "scene-name": _this.lowBitrateScene
          }), _this.previousScene = _this.lowBitrateScene, _this.switchSceneEmit("lowBitrateScene"), log.info("High RTT detected switching to scene: \"".concat(_this.lowBitrateScene, "\""))), rtt < _this.highRttTrigger && bitrate > _this.lowBitrateTrigger && currentScene.name !== _this.normalScene && (_this.obs.setCurrentScene({
          ...
          _this.isLive && canSwitch && (bitrate === 0 && currentScene.name !== _this.previousScene && (_this.obs.setCurrentScene({
            "scene-name": _this.previousScene
          }), _this.switchSceneEmit("live", _this.previousScene), log.info("Stream went online switching to scene: \"".concat(_this.previousScene, "\""))), bitrate <= _this.lowBitrateTrigger && currentScene.name !== _this.lowBitrateScene && bitrate !== 0 && (_this.obs.setCurrentScene({
            "scene-name": _this.lowBitrateScene
          }), _this.previousScene = _this.lowBitrateScene, _this.switchSceneEmit("lowBitrateScene"), log.info("Low bitrate detected switching to scene: \"".concat(_this.lowBitrateScene, "\""))), bitrate > _this.lowBitrateTrigger && currentScene.name !== _this.normalScene && (_this.obs.setCurrentScene({
            "scene-name": _this.normalScene
          }), _this.previousScene = _this.normalScene, _this.switchSceneEmit("normalScene"), log.info("Switching to normal scene: \"".concat(_this.normalScene, "\""))));
        }
      } else {
  ...
  getSceneList() {
    ...
    return _asyncToGenerator(function* () {
      var list = yield _this4.obs.GetSceneList();
  ...
  canSwitch() {
    ...
    return _asyncToGenerator(function* () {
      var currentScene = yield _this5.obs.GetCurrentScene();
