...
function (_EventEmitter) {
  ...
  function ObsSwitcher(address, password, low, normal, offline, lowBitrateTrigger) {
    ...
    _this.lastAllowedScene = offline;
            ...
            switch (_context.prev = _context.next) {
              ...
              case 5:
                ...
                if (bitrate !== null) {
                  ...
                  }), _this2.lastAllowedScene = _this2.lowBitrateScene, _config.default.twitchChat.enableAutoSwitchNotification && _this2.emit("live")), bitrate <= _this2.lowBitrateTrigger && currentScene.name !== _this2.lowBitrateScene && bitrate !== 0 && (_this2.obs.setCurrentScene({
                    "scene-name": _this2.lowBitrateScene
                  }), _config.default.twitchChat.enableAutoSwitchNotification && _this2.emit("lowBitrateScene"), _this2.lastAllowedScene = _this2.lowBitrateScene, console.log("Low bitrate detected switching to scene ".concat(_this2.lowBitrateScene, "."))), bitrate > _this2.lowBitrateTrigger && currentScene.name !== _this2.normalScene && (_this2.obs.setCurrentScene({
                    "scene-name": _this2.normalScene
                  }), _config.default.twitchChat.enableAutoSwitchNotification && _this2.emit("normalScene"), _this2.lastAllowedScene = _this2.normalScene, console.log("Switching back to scene ".concat(_this2.normalScene, "."))));
                } else {
                  _this2.isLive = false;
                  canSwitch && currentScene.name !== _this2.offlineScene && (_this2.obs.setCurrentScene({
                    "scene-name": _this2.offlineScene
                  }), _config.default.twitchChat.enableAutoSwitchNotification && _this2.emit("offlineScene"), _this2.streamStatus = null, _this2.lastAllowedScene = _this2.offlineScene, console.log("Error receiving current bitrate or stream is offline. Switching to scene ".concat(_this2.offlineScene, ".")));
                }
