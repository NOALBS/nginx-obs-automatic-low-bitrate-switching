...
class Chat {
  ...
  start() {
    ...
    return _asyncToGenerator(function* () {
      // start streaming
      try {
        yield _this.obs.startStreaming();
  ...
  stop() {
    ...
    return _asyncToGenerator(function* () {
      // stop streaming
      try {
        yield _this2.obs.stopStreaming();
  ...
  startStopRec(bool) {
    ...
    return _asyncToGenerator(function* () {
      if (bool) {
        try {
          var res = yield _this3.obs.StartRecording();
        ...
        try {
          var _res = yield _this3.obs.StopRecording();
  ...
  switch(sceneName) {
    ...
    return _asyncToGenerator(function* () {
      ...
      try {
        yield _this4.obs.setCurrentScene({
          "scene-name": scene
        });
    ...
    return _asyncToGenerator(function* () {
      if (!_this5.isRefreshing) {
        try {
          ...
          yield _this5.obs.setCurrentScene({
