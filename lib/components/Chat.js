      ...
      if (message !== null) {
        ...
        if (parsed !== null) {
          if (parsed.command === "PRIVMSG") {
            ...
            if (_config.default.allowedUsers.includes(parsed.username) && this.rate != 20 || _config.default.enableTwitchPublicCommands && this.allowAllCommands.includes(commandName) && !this.wait && this.rate != 20) {
